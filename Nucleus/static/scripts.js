...
function addInput(divName){
     if (counter == limit)  {
          alert("You have reached the limit of adding " + counter + " new targets");
     }
     else {
          let newdiv = document.createElement('div');
          newdiv.innerHTML = "<br></br><h>" + "Target" + "</h>" + (counter + 1) + ' <br><label for="demo">Demo</label><input type="text" class="form-control" id="demo'+(counter + 1)+'" name="demo'+(counter + 1)+'" aria-describedby="demo"><label for="geo">Geo</label><input type="text" class="form-control" id="geo'+(counter + 1)+'" name="geo'+(counter + 1)+'"aria-describedby="geo"><label for="contextual">Contextual</label><input type="text" class="form-control" id="contextual'+(counter + 1)+'" name="contextual'+(counter + 1)+'" aria-describedby="contextual"><label for="start">Start Date</label><input type="text" class="form-control" id="start'+(counter + 1)+'" aria-describedby="start" name="start'+(counter + 1)+'" placeholder="2/28/2018"><label for="end">End Date</label><input type="text" class="form-control" id="end'+(counter + 1)+'" aria-describedby="end" name="end'+(counter + 1)+'" placeholder="12/31/2018">';
